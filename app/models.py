...
class Video(Base):
    ...
    bunny_thumbnail_path: Mapped[str | None] = mapped_column(String(1000), nullable=True)
    bunny_thumbnail_url: Mapped[str | None] = mapped_column(String(1000), nullable=True)
